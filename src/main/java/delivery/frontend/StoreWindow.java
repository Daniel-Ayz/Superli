...
public class StoreWindow extends Window{
    public StoreWindow(FactoryService factoryService) {
    ...
    public void open() {
        ...
        Response response = factoryService.getDestinationService().addDestination(address, area, phone, contactName, northCoordination, eastCoordination, false);
        if(!response.hasError())
            print("Store was added successfully");
        else
